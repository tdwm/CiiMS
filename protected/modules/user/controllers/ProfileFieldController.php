...
class ProfileFieldController extends ACiiController
{
    public $layout = "userWarpper";
	...
	public function registerScript() {
		...
		$baseUrl=Yii::app()->getAssetManager()->publish(dirname(__FILE__).'/../views/asset');
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['ProfileField']))
		{
			...
			if($model->validate()) {
                ...
                //echo $sql;	
                //var_dump($_POST['ProfileField']);
                //var_dump($r);exit;
				$r = $model->dbConnection->createCommand($sql)->execute();
				$model->save();
